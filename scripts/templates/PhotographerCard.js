...
/* ----------------------------------------------------------------
    Création de la card d'un photographes
------------------------------------------------------------------- */
    ...
    const photographerCard = `
            ...
            <header class="user-card__header">
              <a href="./photographer.html" 
                ...
                >
                <img class="user-card__picture" src="${this._photographer.portrait}" alt="Photo de ${this._photographer.name}" />
                <h2 class="user-card__name">${this._photographer.name}</h2>
              </a>
            </header>
            <section class="user-card__paragraph">
                <p class="user-card__localization">${this._photographer.city}, ${this._photographer.country}</p>
